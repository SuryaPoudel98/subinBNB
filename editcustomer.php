    ...
    <div class="row mt-5">
      <div class="col-sm-12 mt-4">
        ...
        ?>
          ...
          <form method="POST" class="form-control mt-4" action="editcustomer.php">
            <input type="hidden" name="id" value="<?php echo $id; ?>">
            <p>
              <label for="firstname">Name: </label>
              <input type="text" id="firstname" class="form-control" name="firstname" minlength="5" maxlength="50" required value="<?php echo $row['firstname']; ?>">
            </p>
            <p>
              <label for="lastname">Name: </label>
              <input type="text" id="lastname" class="form-control" name="lastname" minlength="5" maxlength="50" required value="<?php echo $row['lastname']; ?>">
            </p>
            <p>
              <label for="email">Email: </label>
              <input type="email" id="email" name="email" class="form-control" maxlength="100" size="50" required value="<?php echo $row['email']; ?>">
            </p>
